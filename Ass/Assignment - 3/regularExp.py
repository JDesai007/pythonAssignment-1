...
for i in re.finditer("am",str):
    index=i.span() # span() return the starting and ending index of word which match to the regular exprression
    print(index)
...
email="abc67@gmail.com and abc@aajfhasffg.com and my12@gmail.com and abx76@gmaul.....com"
